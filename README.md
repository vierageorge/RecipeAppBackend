...
17. Every time a model is create, create its migrations `docker-compose run --rm app sh -c "python manage.py makemigrations"` and register the model in the admin.
